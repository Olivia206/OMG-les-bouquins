...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { cover: @title.cover, quote: @title.quote, summary: @title.summary } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { cover: @title.cover, quote: @title.quote, summary: @title.summary } }
